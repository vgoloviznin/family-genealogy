...
import { formatCoordinates, mapLink, parseCoordinates } from '@shared/coordinates';
...
describe('mapLink', () => {
  it('builds a Yandex Maps URL', () => {
    expect(mapLink({ latitude: 55.75, longitude: 37.62 })).toBe('https://yandex.ru/maps/?pt=37.62,55.75&z=17&l=map');
  });
});
