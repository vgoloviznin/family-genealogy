...
import { SHARP_DARWIN_PACKAGES, missingSharpDarwinPackages, requiredSharpDarwinPackagesForArch } from '../../scripts/sharp-darwin-binaries.mjs';
...
describe('sharp darwin packaging helpers', () => {
  ...
  it('reports missing packages under node_modules', () => {
    ...
    expect(missingSharpDarwinPackages(root)).toEqual(['@img/sharp-darwin-x64', '@img/sharp-libvips-darwin-arm64', '@img/sharp-libvips-darwin-x64']);
  });
  ...
  it('maps Electron lipo arch to the required sharp package', () => {
    ...
    expect(requiredSharpDarwinPackagesForArch('arm64 x86_64')).toEqual(['@img/sharp-darwin-arm64', '@img/sharp-darwin-x64']);
